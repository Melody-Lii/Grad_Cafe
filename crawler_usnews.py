...
def get_global_rank(headers, page_num = 1):
    ...
    I select some key features including rank, name, score, conutry and district.
    I use request function and Beautiful soup to scrape
    '''
...
df.to_csv(r"/Users/melody/Desktop/Grad_Cafe/Resources/USnew_overall_rank.csv")
