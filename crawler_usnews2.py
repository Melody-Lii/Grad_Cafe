...
def get_stat_rank(headers = headers):
    ...
    I need to deal with the scrolling down issue of this page
    It is about statistics ranking in the United States.
    I select some key features like rank, name, score, and district. 
    I use selenium develop tool with Beautiful soup to scrape
    '''
...
df.to_csv(r"/Users/melody/Desktop/Grad_Cafe/Resources/USnew_stat_rank.csv")
